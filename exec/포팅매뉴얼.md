...
3. 라이브 시연
   ...
   - 매치 등록
   ![createMatch](./gif/createMatch.gif)
   
   - 용병 호출
   ![playerCall](./gif/playerCall.gif)
   
   - 경기 분석 결과
   ![matchResult](./gif/matchResult.gif)

   - 하이라이트
   ![highlight](./gif/highlight.gif)
   
   - 경기 피드백
     ![teamFeedBack](./gif/teamFeedBack.gif)
   
   - 개인 기록
     ![personalFeedback](./gif/personalFeedback.gif)
   
   - 내 정보
     ![myprofile](./gif/myprofile.gif)

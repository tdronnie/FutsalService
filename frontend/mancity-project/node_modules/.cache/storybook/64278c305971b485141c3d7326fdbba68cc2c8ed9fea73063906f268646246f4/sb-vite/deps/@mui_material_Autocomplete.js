...
import "./chunk-HJUQXACU.js";
import "./chunk-UTI6LIPM.js";
import {
  ButtonBase_default
} from "./chunk-BUR3RI4P.js";
import "./chunk-IT65YYOH.js";
import "./chunk-OSA4M537.js";
import {
  useForkRef_default
...
var Autocomplete = React7.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  const renderAutocompletePopperChildren = (children) => (0, import_jsx_runtime8.jsx)(AutocompletePopper, _extends({
    as: PopperComponent,
    disablePortal,
    style: {
    ...
    children: (0, import_jsx_runtime8.jsx)(AutocompletePaper, _extends({
      ownerState,
      as: PaperComponent
    }, paperSlotProps, {
  ...
  if (!loading && groupedOptions.length > 0) {
    autocompletePopper = renderAutocompletePopperChildren((0, import_jsx_runtime8.jsx)(AutocompleteListbox, _extends({
      as: ListboxComponent,

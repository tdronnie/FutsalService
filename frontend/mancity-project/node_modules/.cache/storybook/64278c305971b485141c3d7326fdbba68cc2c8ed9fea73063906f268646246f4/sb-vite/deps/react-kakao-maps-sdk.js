...
var useKakaoMapsSetEffect = function(target, method) {
  ...
  useIsomorphicLayoutEffect(() => {
    if (!target || args.every((arg) => typeof arg === "undefined"))
      return;
...
var InfoWindow = import_react4.default.forwardRef(function InfoWindow2(_ref, ref) {
  ...
  return container.current.parentElement && import_react_dom.default.createPortal(children, container.current.parentElement);
});
...
var MarkerClusterer = import_react5.default.forwardRef(function MarkerClusterer2(_ref, ref) {
  ...
  (0, import_react5.useLayoutEffect)(() => {
    if (markerClusterer && onCreate)
      onCreate(markerClusterer);
...
var Marker = import_react6.default.forwardRef(function Marker2(_ref, ref) {
  ...
  if (children)
    return (0, import_jsx_runtime3.jsx)(InfoWindow, {
      position,
      map,
      marker,
...
var CustomOverlayMap = import_react9.default.forwardRef(function CustomOverlayMap2(_ref, ref) {
  ...
  const container = (0, import_react9.useRef)(document.createElement("div"));
  ...
  return container.current.parentElement && import_react_dom2.default.createPortal(children, container.current.parentElement);
});
...
var Roadview = import_react19.default.forwardRef(function Roadview2(_ref, ref) {
  ...
  useIsomorphicLayoutEffect(() => {
    if (!roadview || !onCreate)
      return;
    onCreate(roadview);
  }, [roadview, onCreate]);
  useIsomorphicLayoutEffect(() => {
    if (!roadview || panoId || roadview.getPosition().getLat() === position.lat && roadview.getPosition().getLng() === position.lng)
      return;
  ...
  useIsomorphicLayoutEffect(() => {
    if (!roadview || !panoId || panoId === roadview.getPanoId() || roadview.getPosition().getLat() === position.lat && roadview.getPosition().getLng() === position.lng)
      return;
    const newPostion = new kakao.maps.LatLng(position.lat, position.lng);
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    if (prevViewpoint.pan === pan && prevViewpoint.tilt === tilt)
      return;
    if (pan)
...
var CustomOverlayRoadview = import_react21.default.forwardRef(function CustomOverlayRoadview2(_ref, ref) {
  ...
  const container = (0, import_react21.useRef)(document.createElement("div"));
  ...
  return container.current.parentElement && import_react_dom3.default.createPortal(children, container.current.parentElement);
});

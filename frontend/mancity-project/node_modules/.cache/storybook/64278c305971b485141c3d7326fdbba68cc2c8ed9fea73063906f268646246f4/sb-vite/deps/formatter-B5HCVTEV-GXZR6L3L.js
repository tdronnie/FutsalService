...
function na(t8) {
  ...
  function d() {
    ...
    for (B = 0; B < n.length; B++)
      g = n[B], y2 = g[g.length - 1], $ = g.substring(0, g.length - 1), w2 = parseInt($, 10), q2 = parseFloat($), Vn.test($) && y2 === "w" ? ((_2 || D) && (C = true), w2 === 0 ? C = true : _2 = w2) : ra.test($) && y2 === "x" ? ((_2 || D || P2) && (C = true), q2 < 0 ? C = true : D = q2) : Vn.test($) && y2 === "h" ? ((P2 || D) && (C = true), w2 === 0 ? C = true : P2 = w2) : C = true;
    if (!C)
      c.source = { value: r, startOffset: u }, _2 && (c.width = { value: _2 }), D && (c.density = { value: D }), P2 && (c.height = { value: P2 }), l.push(c);
    else
...
function Vs(t8, e, r) {
  ...
  let d = (c) => {
    ...
    if (c.type === "element" && (i && (!c.namespace || c.namespace === c.tagDefinition.implicitNamespacePrefix || de(c)) && (c.name = _2(c.name, (g) => Os.has(g))), a))
      for (let g of c.attrs)
...
var Me2 = (e, t8) => () => (t8 || e((t8 = { exports: {} }).exports, t8), t8.exports);
var We = (e, t8) => {
  for (var r in t8)
    $e2(e, r, { get: t8[r], enumerable: true });
};
var nr2 = (e, t8, r, n) => {
  if (t8 && typeof t8 == "object" || typeof t8 == "function")
    for (let o of Fu(t8))
      !du.call(e, o) && o !== r && $e2(e, o, { get: () => t8[o], enumerable: !(n = fu(t8, o)) || n.enumerable });
  return e;
};
var he2 = (e, t8, r) => (r = e != null ? lu(pu(e)) : {}, nr2(t8 || !e || !e.__esModule ? $e2(r, "default", { value: e, enumerable: true }) : r, e));
var Eu = (e) => nr2($e2({}, "__esModule", { value: true }), e);
var Cu = (e, t8, r) => {
  if (!t8.has(e))
    throw TypeError("Cannot " + r);
};
...
var ce2 = (e, t8, r) => (Cu(e, t8, "access private method"), r);
var or2 = Me2((gt2) => {
  ...
  ur2.prototype = { diff: function(t8, r) {
    ...
    function p() {
      for (var F2 = -1 * a; F2 <= a; F2 += 2) {
        ...
        if (!h2 || B && E2.newPos < C.newPos ? (m = yu(C), u.pushComponent(m.components, void 0, true)) : (m = E2, m.newPos++, u.pushComponent(m.components, true, void 0)), g = u.extractCommon(m, r, t8, F2), m.newPos + 1 >= s && g + 1 >= D)
...
var O2 = "label";
var b2 = "break-parent";
var Ue2 = /* @__PURE__ */ new Set([W2, T2, S2, v2, _, k2, x2, P, L2, I2, A2, O2, b2]);
function xu(e) {
  if (typeof e == "string")
    return M;
  if (Array.isArray(e))
...
var le2 = { type: b2 };
var mr2 = { type: v2 };
var _e2 = { type: A2, hard: true };
var Bt2 = { type: A2, hard: true, literal: true };
var Ke2 = { type: A2 };
var Er2 = { type: A2, soft: true };
var G2 = [_e2, le2];
var He2 = [Bt2, le2];
var xe2 = { type: W2 };
function ke2(e, t8) {
...
function kr(e) {
  for (e = [...e]; e.length >= 2 && y(false, e, -2).type === A2 && y(false, e, -1).type === b2; )
    e.length -= 2;
  if (e.length > 0) {
...
var K2 = Symbol("MODE_FLAT");
var Te2 = Symbol("cursor");
function vr2() {
        ...
        switch (p) {
          ...
          case R2: {
            ...
            if (!l.break && Qe2(F2, i, m, E2, r))
              ...
              i.push({ ind: f2, mode: R2, doc: l.contents });
            break;
          }
        }
...
function Pr2(e) {
  ...
  function n(u, i, s) {
    ...
    if (u.type === b2)
      return ((a = s == null ? void 0 : s[i - 1]) == null ? void 0 : a.type) === A2 && s[i - 1].hard ? void 0 : "breakParent";
    if (u.type === v2)
      return "trim";
    if (u.type === T2)
...
function et2({ plugins: e = [], showDeprecated: t8 = false } = {}) {
  ...
  for (let o of $u(Object.assign({}, ...e.map(({ options: u }) => u), Lr)))
    !t8 && o.deprecated || (Array.isArray(o.choices) && (t8 || (o.choices = o.choices.filter((u) => !u.deprecated)), o.name === "parser" && (o.choices = [...o.choices, ...Vu(o.choices, r, e)])), o.pluginDefaults = Object.fromEntries(e.filter((u) => {
      var i;
...
function Wu(e, t8) {
  if (t8)
    return e.find(({ name: r }) => r.toLowerCase() === t8) ?? e.find(({ aliases: r }) => r == null ? void 0 : r.includes(t8)) ?? e.find(({ extensions: r }) => r == null ? void 0 : r.includes(`.${t8}`));
}
function Uu(e, t8) {
...
var Rr = Uu;
var te2 = { key: (e) => /^[$_a-zA-Z][$_a-zA-Z0-9]*$/.test(e) ? e : JSON.stringify(e), value(e) {
...
var se2 = he2(Pe2(), 1);
var tt2 = Symbol.for("vnopts.VALUE_NOT_EXIST");
var pe2 = Symbol.for("vnopts.VALUE_UNCHANGED");
var $r2 = " ".repeat(2);
var Wr = (e, t8, r) => {
...
async function Qu(e, t8 = {}) {
  ...
  if (!r.parser)
    if (r.filepath) {
      ...
      throw new ve2("No parser and no file path given, couldn't infer a parser.");
...
var re2 = Qu;
var ln2 = /* @__PURE__ */ new Set(["tokens", "comments", "parent", "enclosingNode", "precedingNode", "followingNode"]);
var eo = (e) => Object.keys(e).filter((t8) => !ln2.has(t8));
function to(e) {
...
function Nn2(e, t8) {
  ...
  for (let [p, l] of f2.entries()) {
    ...
    let $;
    if (i ? $ = [l] : (F2.enclosingNode = E2, F2.precedingNode = m, F2.followingNode = C, $ = [F2, g, h2, B, Z]), Co2(g, h2, f2, p))
...
var To2 = /* @__PURE__ */ new Set(["OperationDefinition", "FragmentDefinition", "VariableDefinition", "TypeExtensionDefinition", "ObjectTypeDefinition", "FieldDefinition", "DirectiveDefinition", "EnumTypeDefinition", "EnumValueDefinition", "InputValueDefinition", "InputObjectTypeDefinition", "SchemaDefinition", "OperationTypeDefinition", "InterfaceTypeDefinition", "UnionTypeDefinition", "ScalarTypeDefinition"]);
function Vn2(e, t8, r) {
  if (!t8)
    return false;
  switch (e.parser) {
...
function Mn2(e, t8, r) {
  ...
  if (bo2(t8)) {
    ...
    ({ startNode: d, endNode: f2 } = Oo(a, c, t8));
...
function So2(e, t8) {
  ...
  for (let D of bn2(e, { getVisitorKeys: u, filter: i }))
    s = D;
  return s;
}
var Wn2 = So2;
var Hn2 = "\uFEFF";
var Un2 = Symbol("cursor");
...
var Xo = { join: ke2, line: Ke2, softline: Er2, hardline: G2, literalline: He2, group: At2, conditionalGroup: fr2, fill: Ge2, lineSuffix: Be2, lineSuffixBoundary: dr2, cursor: xe2, breakParent: le2, ifBreak: Fr2, trim: mr2, indent: ie2, indentIfBreak: pr2, align: oe2, addAlignmentToDoc: qe2, markAsRoot: cr2, dedentToRoot: ar2, dedent: lr2, hardlineWithoutBreakParent: _e2, literallineWithoutBreakParent: Bt2, label: Cr2, concat: (e) => e };
var Zo = { printDocToString: fe2 };
var Qo = { willBreak: wr2, traverseDoc: Ae2, findInDoc: Je2, mapDoc: Ne2, removeLines: Nr2, stripTrailingHardline: Xe2, replaceEndOfLine: Tr2, canBreak: Sr2 };
var Du = "3.1.1";
function ae(e, t8 = 1) {
  return async (...r) => {
...
var ti2 = ae(et2, 0);
var ri2 = { parse: ae(Xn2), formatAST: ae(Zn2), formatDoc: ae(Qn2), printToDoc: ae(eu), printDocToString: ae(tu) };
var qc = tr2;
...
var formatter = (0, import_memoizerific.default)(2)(async (type, source) => type === false ? source : type === "dedent" || type === true ? dedent(source) : (await qc.format(source, { parser: type, plugins: [dh], htmlWhitespaceSensitivity: "ignore" })).trim());
export {
  formatter
};
//# sourceMappingURL=formatter-B5HCVTEV-GXZR6L3L.js.map

...
function $e(e2, n2) {
  ...
  return { match(e3, n3, t3) {
    ...
    return { items: c2.map(function(e4, t3) {
      ...
      let h2;
      r3.list = true, u2 ? (r3.inline = false, h2 = s2.replace(oe, "\n\n")) : (r3.inline = true, h2 = s2.replace(oe, ""));
      const m2 = n3(h2, r3);
...
var Se = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/;
var we = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/;
var Ce = [u, m, g, C, A, E, L, N, ye, ve, ke, be];
var Ee = [...Ce, /^[^\n]+(?:  \n|\n{2,})/, O, M];
function Ae(e2) {
...
function Te(e2, n2, t2) {
  const r2 = t2.inTable;
  t2.inTable = true;
  const i2 = n2(e2.trim(), t2);
  t2.inTable = r2;
  let l2 = [[]];
  return i2.forEach(function(e3, n3) {
    "26" === e3.type ? 0 !== n3 && n3 !== i2.length - 1 && l2.push([]) : ("27" !== e3.type || null != i2[n3 + 1] && "26" !== i2[n3 + 1].type || (e3.text = e3.text.replace(q, "")), l2[l2.length - 1].push(e3));
  }), l2;
}
function Le(e2, n2, t2) {
  t2.inline = true;
  const r2 = Te(e2[1], n2, t2), i2 = e2[2].replace(Z, "").split("|").map(Oe), l2 = function(e3, n3, t3) {
...
var _e = (e2, n2, t2) => ({ children: He(n2, e2[1], t2) });
function Fe() {
  return {};
}
function We() {
...
function qe(t2, r2 = {}) {
  r2.overrides = r2.overrides || {}, r2.slugify = r2.slugify || Ae, r2.namedCodesToUnicode = r2.namedCodesToUnicode ? n({}, o, r2.namedCodesToUnicode) : o;
  const i2 = r2.createElement || e.createElement;
  function d2(e2, t3, ...l2) {
    const o2 = Ze(r2.overrides, `${e2}.props`, {});
    return i2(function(e3, n2) {
      const t4 = Ze(n2, e3);
      return t4 ? "function" == typeof t4 || "object" == typeof t4 && "render" in t4 ? t4 : Ze(n2, `${e3}.component`, e3) : e3;
    }(e2, r2.overrides), n({}, t3, o2, { className: Ge(null == t3 ? void 0 : t3.className, o2.className) || void 0 }), ...l2);
  }
  function Z2(n2) {
    n2 = n2.replace(S, "");
    let t3 = false;
...
`, { inline: t3 }));
    ...
    return t3 ? t3.reduce(function(n3, t4, r3) {
      ...
      if (-1 !== i3) {
        const o2 = function(e2) {
          return -1 !== e2.indexOf("-") && null === e2.match(z) && (e2 = e2.replace(B, function(e3, n4) {
          ...
          }, {}) : "href" === e2 || "src" === e2 ? Be(n4) : (n4.match(I) && (n4 = n4.slice(1, n4.length - 1)), "true" === n4 || "false" !== n4 && n4);
        }(o2, c2);
        "string" == typeof s2 && (O.test(s2) || M.test(s2)) && (n3[a2] = e.cloneElement(Z2(s2.trim()), { key: r3 }));
      } else
        "style" !== t4 && (n3[l[t4] || t4] = true);
      return n3;
    }, {}) : null;
  }
  const V2 = [], X2 = {}, Q2 = { 0: { match: Re(u), order: 1, parse: (e2, n2, t3) => ({ children: n2(e2[0].replace(p, ""), t3) }), render: (e2, n2, t3) => d2("blockquote", { key: t3.key }, n2(e2.children, t3)) }, 1: { match: Ue(f), order: 1, parse: Fe, render: (e2, n2, t3) => d2("br", { key: t3.key }) }, 2: { match: Re(h), order: 1, parse: Fe, render: (e2, n2, t3) => d2("hr", { key: t3.key }) }, 3: { match: Re(g), order: 0, parse: (e2) => ({ lang: void 0, text: e2[0].replace(/^ {4}/gm, "").replace(/\n+$/, "") }), render: (e2, t3, r3) => d2("pre", { key: r3.key }, d2("code", n({}, e2.attrs, { className: e2.lang ? `lang-${e2.lang}` : "" }), e2.text)) }, 4: { match: Re(m), order: 0, parse: (e2) => ({ attrs: q2(e2[3] || ""), lang: e2[2] || void 0, text: e2[4], type: "3" }) }, 5: { match: Ie(y), order: 3, parse: (e2) => ({ text: e2[2] }), render: (e2, n2, t3) => d2("code", { key: t3.key }, e2.text) }, 6: { match: Re(v), order: 0, parse: (e2) => (V2.push({ footnote: e2[2], identifier: e2[1] }), {}), render: We }, 7: { match: Me(b), order: 1, parse: (e2) => ({ target: `#${r2.slugify(e2[1])}`, text: e2[1] }), render: (e2, n2, t3) => d2("a", { key: t3.key, href: Be(e2.target) }, d2("sup", { key: t3.key }, e2.text)) }, 8: { match: Me(w), order: 1, parse: (e2) => ({ completed: "x" === e2[1].toLowerCase() }), render: (e2, n2, t3) => d2("input", { checked: e2.completed, key: t3.key, readOnly: true, type: "checkbox" }) }, 9: { match: Re(r2.enforceAtxHeadings ? E : C), order: 1, parse: (e2, n2, t3) => ({ children: He(n2, e2[2], t3), id: r2.slugify(e2[2]), level: e2[1].length }), render: (e2, n2, t3) => d2(`h${e2.level}`, { id: e2.id, key: t3.key }, n2(e2.children, t3)) }, 10: { match: Re(A), order: 0, parse: (e2, n2, t3) => ({ children: He(n2, e2[1], t3), level: "=" === e2[2] ? 1 : 2, type: "9" }) }, 11: { match: Ue(O), order: 1, parse(e2, n2, t3) {
    const [, r3] = e2[3].match(ie), i3 = new RegExp(`^${r3}`, "gm"), l2 = e2[3].replace(i3, ""), o2 = (a2 = l2, Ee.some((e3) => e3.test(a2)) ? Pe : He);
    var a2;
    const s2 = e2[1].toLowerCase(), d3 = -1 !== c.indexOf(s2), u2 = { attrs: q2(e2[2]), noInnerParse: d3, tag: d3 ? s2 : e2[1] };
    return t3.inAnchor = t3.inAnchor || "a" === s2, d3 ? u2.text = e2[3] : u2.children = o2(n2, l2, t3), t3.inAnchor = false, u2;
  }, render: (e2, t3, r3) => d2(e2.tag, n({ key: r3.key }, e2.attrs), e2.text || t3(e2.children, r3)) }, 13: { match: Ue(M), order: 1, parse: (e2) => ({ attrs: q2(e2[2] || ""), tag: e2[1] }), render: (e2, t3, r3) => d2(e2.tag, n({}, e2.attrs, { key: r3.key })) }, 12: { match: Ue(L), order: 1, parse: () => ({}), render: We }, 14: { match: Ie(we), order: 1, parse: (e2) => ({ alt: e2[1], target: Ne(e2[2]), title: e2[3] }), render: (e2, n2, t3) => d2("img", { key: t3.key, alt: e2.alt || void 0, title: e2.title || void 0, src: Be(e2.target) }) }, 15: { match: Me(Se), order: 3, parse: (e2, n2, t3) => ({ children: De(n2, e2[1], t3), target: Ne(e2[2]), title: e2[3] }), render: (e2, n2, t3) => d2("a", { key: t3.key, href: Be(e2.target), title: e2.title }, n2(e2.children, t3)) }, 16: { match: Me(j), order: 0, parse: (e2) => ({ children: [{ text: e2[1], type: "27" }], target: e2[1], type: "15" }) }, 17: { match: (e2, n2) => n2.inAnchor ? null : Me(R)(e2, n2), order: 0, parse: (e2) => ({ children: [{ text: e2[1], type: "27" }], target: e2[1], title: void 0, type: "15" }) }, 18: { match: Me(U), order: 0, parse(e2) {
    let n2 = e2[1], t3 = e2[1];
    return s.test(t3) || (t3 = "mailto:" + t3), { children: [{ text: n2.replace("mailto:", ""), type: "27" }], target: t3, type: "15" };
  } }, 20: $e(d2, 1), 33: $e(d2, 2), 19: { match: Re(k), order: 3, parse: Fe, render: () => "\n" }, 21: { match: je, order: 3, parse: _e, render: (e2, n2, t3) => d2("p", { key: t3.key }, n2(e2.children, t3)) }, 22: { match: Me(H), order: 0, parse: (e2) => (X2[e2[1]] = { target: e2[2], title: e2[4] }, {}), render: We }, 23: { match: Ie(D), order: 0, parse: (e2) => ({ alt: e2[1] || void 0, ref: e2[2] }), render: (e2, n2, t3) => d2("img", { key: t3.key, alt: e2.alt, src: Be(X2[e2.ref].target), title: X2[e2.ref].title }) }, 24: { match: Me(P), order: 0, parse: (e2, n2, t3) => ({ children: n2(e2[1], t3), fallbackChildren: n2(e2[0].replace(_, "\\$1"), t3), ref: e2[2] }), render: (e2, n2, t3) => X2[e2.ref] ? d2("a", { key: t3.key, href: Be(X2[e2.ref].target), title: X2[e2.ref].title }, n2(e2.children, t3)) : d2("span", { key: t3.key }, n2(e2.fallbackChildren, t3)) }, 25: { match: Re(N), order: 1, parse: Le, render: (e2, n2, t3) => d2("table", { key: t3.key }, d2("thead", null, d2("tr", null, e2.header.map(function(r3, i3) {
    ...
    return { type: "26" };
  }, render: () => " | " }, 27: { match: Ue(te), order: 4, parse: (e2) => ({ text: e2[0].replace(T, (e3, n2) => r2.namedCodesToUnicode[n2] ? r2.namedCodesToUnicode[n2] : e3) }), render: (e2) => e2.text }, 28: { match: Ie(J), order: 2, parse: (e2, n2, t3) => ({ children: n2(e2[2], t3) }), render: (e2, n2, t3) => d2("strong", { key: t3.key }, n2(e2.children, t3)) }, 29: { match: Ie(K), order: 3, parse: (e2, n2, t3) => ({ children: n2(e2[2], t3) }), render: (e2, n2, t3) => d2("em", { key: t3.key }, n2(e2.children, t3)) }, 30: { match: Ie(ne), order: 1, parse: (e2) => ({ text: e2[1], type: "27" }) }, 31: { match: Ie(Y), order: 3, parse: _e, render: (e2, n2, t3) => d2("mark", { key: t3.key }, n2(e2.children, t3)) }, 32: { match: Ie(ee), order: 3, parse: _e, render: (e2, n2, t3) => d2("del", { key: t3.key }, n2(e2.children, t3)) } };
  ...
  return V2.length ? d2("div", null, ae2, d2("footer", { key: "footer" }, V2.map(function(e2) {
    return d2("div", { id: r2.slugify(e2.identifier), key: e2.identifier }, e2.identifier, oe2(le2(e2.footnote, { inline: true })));
  }))) : ae2;
}
...
//# sourceMappingURL=chunk-VGMWBJ5J.js.map

...
function ListProvider(props) {
  ...
  const baseProviders = (0, import_jsx_runtime.jsx)(RowListContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime.jsx)(WrapListContext_default.Provider, {
      value: wrap,
      children: React6.Children.map(children, (child, index) => React6.isValidElement(child) ? React6.cloneElement(child, _extends({}, index === 0 && {
        "data-first-child": ""
      }, index === React6.Children.count(children) - 1 && {
        "data-last-child": ""
      })) : child)
    })
  });
...
var List = React8.forwardRef(function List2(inProps, ref) {
  var _inProps$size;
  const nesting = React8.useContext(NestedListContext_default);
  const group = React8.useContext(GroupListContext_default);
  const radioGroupContext = React8.useContext(RadioGroupContext_default);
...
//# sourceMappingURL=chunk-ZUVP4ALA.js.map

...
import react__default, { ComponentProps, MouseEvent, AnchorHTMLAttributes, ReactNode, ReactElement, Component, RefObject, ButtonHTMLAttributes, SyntheticEvent, FC, PropsWithChildren, RefAttributes, DetailedHTMLProps, ElementType } from 'react';
...
declare const ScrollArea: ({ children, horizontal, vertical, offset, scrollbarSize, className, }: ScrollAreaProps) => react__default.JSX.Element;
...
declare const Form: _storybook_theming.StyledComponent<{
    ...
    Field: {
        ({ label, children, ...props }: FieldProps): react.JSX.Element;
        defaultProps: {
            label: any;
        };
    };
...
declare const LazyWithTooltipPure: react__default.LazyExoticComponent<{
    ({ svg, trigger, closeOnOutsideClick, placement, hasChrome, withArrows, offset, tooltip, children, closeOnTriggerHidden, mutationObserverOptions, defaultVisible, delayHide, visible, interactive, delayShow, modifiers, strategy, followCursor, onVisibleChange, ...props }: WithTooltipPureProps): react__default.JSX.Element;
    defaultProps: {
        svg: boolean;
        trigger: string;
        closeOnOutsideClick: boolean;
...
declare const ListItem: {
    ({ loading, title, center, right, icon, active, disabled, isIndented, href, onClick, LinkWrapper, ...rest }: ListItemProps): react__default.JSX.Element;
    defaultProps: {
        loading: boolean;

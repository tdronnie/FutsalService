...
import path2__default, { win32, posix, join, parse, dirname, isAbsolute, relative, resolve } from 'path';
import { NoStatsForViteDevError } from '@storybook/core-events/server-errors';
import { normalizeStories, getBuilderOptions, resolvePathInStorybookCache, isPreservingSymlinks, getFrameworkName, commonGlobOptions, stringifyEnvs, loadPreviewOrConfigFile, stripAbsNodeModulesPath } from '@storybook/core-common';
